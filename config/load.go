...
func load(cmdline, environ, envprefix []string, props *properties.Properties) (cfg *Config, err error) {
	...
	f.StringVar(&cfg.Consul.CAFile, "consul.cafile", defaultConfig.Consul.CAFile, "Public cert of consul CA. To be used with https scheme")
	f.StringVar(&cfg.Consul.CertFile, "consul.certfile", defaultConfig.Consul.CertFile, "Public cert of consul cli. To be used with https scheme")
	f.StringVar(&cfg.Consul.KeyFile, "consul.keyfile", defaultConfig.Consul.KeyFile, "Private key of consul cli. To be used with https scheme")
